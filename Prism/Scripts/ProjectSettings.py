...
class ProjectSettings(QDialog, ProjectSettings_ui.Ui_dlg_ProjectSettings):
    ...
    def connectEvents(self):
        ...
        self.b_resetStructure.clicked.connect(lambda: self.resetProjectStructure())
        ...
        self.b_reqPlugins.clicked.connect(lambda: self.onRequiredPluginsClicked())
        self.b_expectedPrjPath.clicked.connect(lambda: self.onBrowseExpPathClicked())
